...
bucket = storage_client.bucket("sid-ml-ops-yeifer")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "vertex-ai-project-428921.ml_ops_yeifer.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://sid-ml-ops-yeifer/bank_campaign_data/bank-campaign-training-data.csv"
    model_name = 'xgboost'
