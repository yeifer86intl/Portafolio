...
#model_path = "model/trained_model.h5"  # Asegúrate de especificar la ruta correcta
model = load_model("trained_model.h5")

def predict(image_name):
    """
    Cargar imagen de la carpeta correspondiente según el nombre de la imagen
    recibida, luego, ejecutar el modelo ML para obtener predicciones.
    ...
    class_name, pred_probability : tuple(str, float)
        Clase predicha por el modelo como una cadena y el puntaje de confianza correspondiente.
    """
